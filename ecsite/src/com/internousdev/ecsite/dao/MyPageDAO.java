...
public class MyPageDAO {
	...
	public ArrayList<MyPageDTO> getMyPageUserInfo(String item_transaction_id, String user_master_id)
		...
		+ "FROM user_buy_item_transaction4 ubit "
		+ "LEFT JOIN item_info_transaction4 iit "
	...
	public int buyItemHistoryDelete(String item_transaction_id, String user_master_id) throws SQLException{
		String sql=
				"DELETE FROM user_buy_item_transaction4 WHERE item_transaction_id = ? AND user_master_id = ?";
