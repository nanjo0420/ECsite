...
public class CartInfoDAO {
	...
	public List<CartInfoDTO> getCartInfoDtoList(String loginId){
		...
		String sql = "select"
				...
				+ " FROM cart_info2 as ci"
				+ " LEFT JOIN product_info2 as pi"
	...
	public int getTotalPrice(String userId){
		...
		DBConnector dbConnector = new DBConnector();
		Connection connection = dbConnector.getConnection();
		String sql = "select sum(product_count * price) as total_price from cart_info2 where user_id = ? group by user_id";
		try{
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
	...
	public int regist(String userId, String tempUserId, int productId, String productCount, int price){
		...
		Connection connection = dbConnector.getConnection();
		int count = 0;
		String sql = "insert into cart_info2(user_id, temp_user_id, product_id, product_count, price, regist_date)"
				+ " values (?, ?, ?, ?, ?, now())";
	...
	public int delete(String id){
		...
		Connection connection = dbConnector.getConnection();
		int count = 0;
		String sql = "delete from cart_info2 where id=?";
	...
	public int deleteAll(String userId){
		...
		Connection connection = dbConnector.getConnection();
		int count = 0;
		String sql = "delete from cart_info2 where user_id=?";
	...
	public int linkToLoginId(String tempUserId, String loginId){
		...
		Connection connection = dbConnector.getConnection();
		int count = 0;
		String sql = "update cart_info2 set user_id=?, temp_user_id = null where temp_user_id=?";
