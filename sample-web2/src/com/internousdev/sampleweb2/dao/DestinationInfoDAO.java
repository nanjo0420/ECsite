...
public class DestinationInfoDAO {
	...
	public int insert(String userId, String familyName, String firstName, String familyNameKana, String firstNameKana,
		...
		int count = 0;
		String sql = "insert into destination_info2(user_id, family_name, first_name, family_name_kana, fist_name_kana, email, tel_number, user_address, regist_date, update_date)"
	...
	public List<DestinationInfoDTO> getDestinationInfo(String loginId) throws SQLException{
		...
		String sql ="SELECT id, family_name, first_name, family_name_kana, fist_name_kana, user_address, tel_number, email FROM destination_info2 WHERE user_id=?";
		...
		try{
			...
			while(rs.next()){
				...
				destinationInfoDTO.setFirstNameKana(rs.getString("fist_name_kana"));
