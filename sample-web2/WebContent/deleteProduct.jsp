...
<!--<script type="text/javascript">
	function goDeleteCartAction(){
		document.getElementById("from").action='DeleteProductCompleteAction';
	}
</script> -->
</head>
<body>
...
<s:if test="#session.checkedListErrorMessageList!=null">
	<div class="error">
		<div class="error-message">
		<s:iterator value="#session.checkedListErrorMessageList">
		<s:property />
		</s:iterator>
		</div>
	</div>
...
<s:form id="form" action="DeleteProductCompleteAction">
